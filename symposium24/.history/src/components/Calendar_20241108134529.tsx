...
const eventStyleGetter = (event: CalendarEvent) => {
  ...
  const baseStyle = {
    workshop: 'bg-green-500 hover:bg-green-600 border-green-600',
    lecture: 'bg-green-500 hover:bg-green-600 border-green-600',
    networking: 'bg-purple-500 hover:bg-purple-600 border-purple-600'
  }[event.type] || 'bg-blue-500 hover:bg-blue-600 border-blue-600'
